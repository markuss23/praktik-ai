...
class ClosedQuestionsSettings(BaseModel):
    """
    Student prochází otázky po jedné ze zásobníku. U každé otázky má
    ``max_attempts`` pokusů na správnou odpověď — dokud je nevyčerpá,
    zůstává na stejné otázce; teprve pak (správně, nebo po vyčerpání
    pokusů) postupuje na další. Na konci skóre proti prahu úspěšnosti.
    """
